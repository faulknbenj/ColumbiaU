...
max US deaths in a day
```{r MaxDeaths, echo = TRUE}
max(US_total$deaths)
```

Looking at whether cases are slowing down
...
Applying visualization to new cases/deaths
...
Applying visualization of new cases/deaths to state
